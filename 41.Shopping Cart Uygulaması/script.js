...
class Products{
    async getProduct(){
        try {
            let result= await fetch("https://67ca051b102d684575c44032.mockapi.io/shopping-cart/Shoppin-Cart");
...
document.addEventListener("DOMContentLoaded",()=>{
    const ui=new UI();
     ...
     products.getProduct().then(products=>{
            ui.displayProducts(products)// datayı aldık aldığımız veriyi ui kısmına displayProducts metoduna gönderdik
