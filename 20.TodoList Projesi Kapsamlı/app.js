...
function filter(e){   // filtreleme yapar
...
function addTodo(e){
    const inputText= addInput.value.trim();  // Boşlukları temizler
    if(inputText === ""){
      showAlert("danger","Lütfen boş bırakmayınız!!")
    } else {
        // Arayüze ekleme
        addTodoToUı(inputText);
...
function showAlert(type,message){
    ...
    setTimeout(function(){   // 2,5 saniye sorsa divi kaldırır.
         div.remove();   
    },2500)
}
